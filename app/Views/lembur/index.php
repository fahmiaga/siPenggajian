            ...
            <tbody>
                ...
                foreach ($tanggal as $tgl) : ?>
                    <tr>
                        ...
                        <td><?= $tgl['tanggal']; ?></td>
                        <td>
                            <a href="/lembur/create/<?= $tgl['id_tanggal']; ?>" class="text-primary"><i class="fas fa-plus"></i></a>
                            <a href="/lembur/detail/<?= $tgl['id_tanggal']; ?>" class="text-info"><i class="fas fa-eye"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
